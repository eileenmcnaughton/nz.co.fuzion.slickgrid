...
class CRM_Slickgrid_Page_SlickGrid extends CRM_Core_Page {
  ...
  function run() {
    ...
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/lib/jquery-1.7.min.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/lib/jquery-ui-1.8.16.custom.min.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/lib/jquery.event.drag-2.2.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/slick.core.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/plugins/slick.cellrangedecorator.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/plugins/slick.cellrangeselector.js')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/plugins/slick.cellselectionmodel.js')
    ...
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/slick.grid.js')
    ->addStyleFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/slick.grid.css')
   ...
   // ->addScriptFile('nz.co.fuzion.slickgrid', 'templates/CRM/Slickgrid/Page/contactEditor.js')// can't add like this as need to set script type
    ...
    ->addStyleFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/examples/examples.css')
    ->addStyleFile('nz.co.fuzion.slickgrid', 'css/civislick.css')
    ->addScriptFile('nz.co.fuzion.slickgrid', 'packages/SlickGrid/examples/slick.compositeeditor.js')
